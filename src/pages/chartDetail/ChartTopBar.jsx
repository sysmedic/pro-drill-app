...
export default function ChartTopBar({
  ...
  const manualSections = isEditMode ? [
    {
      items: [
        { iconName: "back", title: "[고객관리] 버튼", desc: "터치 시 변경된 차트 내용의 저장 유무를 확인하고 메인 고객 명단 화면으로 돌아갑니다." },
        { iconName: "chart", title: "[chart] 버튼", desc: "수치 입력 화면을 종료하고, 입력된 수치가 반영된 깔끔한 지공 차트 도면 화면으로 즉시 전환합니다." },
        { iconName: "save", title: "[저장] 버튼", desc: "현재 작성하거나 수정한 차트 데이터를 안전하게 즉시 저장합니다." }
      ]
    }
  ] : [
    {
      items: [
        { iconName: "back", title: "[고객관리] 버튼", desc: "터치 시 변경된 차트 내용의 저장 유무를 확인하고 메인 고객 명단 화면으로 돌아갑니다." },
        { iconName: "memo", title: "[메모] 버튼", desc: "지공 차트 위의 원하는 위치(중지, 약지, 엄지 부근 등)를 터치하여 메모를 작성할 수 있습니다." },
        { iconName: "history", title: "[기록] 버튼", desc: "고객의 과거 차트 저장 기록 및 타임라인 로그를 팝업으로 열어 과거 이력 및 수치를 조회하고 불러올 수 있습니다." },
        { iconName: "edit", title: "[수정] 버튼", desc: "차트 수치를 변경할 수 있는 편집 모드로 즉시 전환합니다." },
        { iconName: "save", title: "[저장] 버튼", desc: "현재 작성하거나 수정한 차트 데이터를 안전하게 즉시 저장합니다." },
        { iconName: "history", title: "[기록 배너] 버튼 (하단 롤링 배너)", desc: "\"현재 OO 기록입니다\" \u2194\uFE0F \"클릭하여 새 차트로 만들기\" 문구가 교차 표시되는 하단 배너를 터치하면, 현재 수치를 유지한 채 새 차트로 복제 생성이 가능합니다." }
      ],
