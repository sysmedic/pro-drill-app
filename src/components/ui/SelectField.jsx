...
const controlClasses = {
  ...
  compact: 'h-10 w-full border border-slate-300 rounded-md bg-white px-2 py-1.5 text-sm text-black font-semibold focus:outline-none focus:ring-2 focus:ring-indigo-500',
};
