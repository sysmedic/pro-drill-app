    ...
    <div className="space-y-4 animate-fade-in p-4 sm:p-5">
      ...
      <div className="bg-white border border-slate-300 rounded-2xl p-3.5 sm:p-5 shadow-2xs space-y-3.5 sm:space-y-4">
        ...
        <div className="flex items-center justify-between gap-1.5 pb-1">
          ...
          {/* 오른쪽 우상단 손방향 토글 */}
          <div className="flex items-center bg-slate-100 border border-slate-300 p-0.5 rounded-md h-8 sm:h-9 w-36 sm:w-44 shrink-0 shadow-2xs">
            <button
              type="button"
        ...
        <div className="space-y-3 sm:space-y-4 bg-slate-50 p-3 sm:p-4 rounded-xl border border-slate-300">
          {/* 섹션 1: 엄지 피치 4개 필드 */}
          ...
          <div className="pt-2.5 sm:pt-3 border-t border-slate-300 space-y-2">
